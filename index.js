const TelegramBot = require("node-telegram-bot-api"),
    ...
    host = "0.0.0.0",
    externalUrl = process.env.CUSTOM_ENV_VARIABLE || "https://my-first-telegram-bot-1.herokuapp.com",
    token = '1715459031:AAGWHxzh6wA_iL4eqq_XsHus3cPnKybY6To',
...
function mainMenu(chatId) {
    const opts = {
        reply_markup: JSON.stringify({
            inline_keyboard: [
                [
                    {text: "Узнать текущий баланс", callback_data: "balance"},
                    {text: "Создать новую карточку", callback_data: "new-card"}
                ]
            ]
        })
    };
